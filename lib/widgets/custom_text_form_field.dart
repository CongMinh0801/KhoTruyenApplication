...
class CustomTextFormField extends StatelessWidget {
  ...
  final int? maxLines; // Thêm thuộc tính maxLines
  ...
  Widget get textFormFieldWidget => SizedBox(
    ...
    child: TextFormField(
      ...
      obscureText: obscureText! && (maxLines ?? 1) == 1,
  ...
  InputDecoration get decoration => InputDecoration(
    hintText: hintText ?? "",
    hintStyle:
    hintStyle ?? CustomTextStyles.bodyMediumOpenSansBluegray800a3,
    prefixIcon: prefix,
    ...
    border: borderDecoration ??
        OutlineInputBorder(
          ...
          borderSide: BorderSide(
            color: appTheme.blueGray800A3.withOpacity(0.16),
            width: 1,
          ),
        ),
