...
class BangxephangItemWidget extends StatelessWidget {
  const BangxephangItemWidget({
    Key? key,
    required this.index,
    required this.sachData,
    required this.sortValue, // Thêm khởi tạo cho sortValue
  }) : super(key: key);
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8.v),
                    Text(
                      "Số lượt đọc: ${sachData?["so_luot_doc"]?[sortValue == 0 ? "theo_thang" : sortValue == 1 ? "theo_tuan" : "theo_ngay"]?.toString() ?? 0}",
